...
const strings = {
  en: {
    ...
    notif_update_body: 'DeepNode Download Manager v{v} is out. Click to open the app and update.',
  ...
  tr: {
    ...
    notif_update_title: 'Güncelleştirme var',
    notif_update_body: 'DeepNode Download Manager v{v} yayınlandı. Güncellemek için tıklayın.',
  ...
  es: {
    ...
    notif_update_body: 'DeepNode Download Manager v{v} ha sido publicado. Haz clic para actualizar.',
  ...
  'pt-BR': {
    ...
    notif_update_title: 'Atualização disponível',
    notif_update_body: 'DeepNode Download Manager v{v} foi lançado. Clique para atualizar.',
  ...
  ru: {
    ...
    notif_update_title: 'Доступно обновление',
    notif_update_body: 'Вышла версия DeepNode Download Manager v{v}. Нажмите, чтобы обновиться.',
  ...
  de: {
    ...
    notif_update_title: 'Update verfügbar',
    notif_update_body: 'DeepNode Download Manager v{v} ist da. Zum Aktualisieren klicken.',
  ...
  fr: {
    ...
    notif_update_body: 'DeepNode Download Manager v{v} est disponible. Cliquez pour mettre à jour.',
  ...
  'zh-CN': {
    ...
    notif_update_title: '有可用更新',
    notif_update_body: 'DeepNode Download Manager v{v} 已发布。点击进行更新。',
  ...
  ar: {
    ...
    notif_update_title: 'يتوفر تحديث',
    notif_update_body: 'صدر الإصدار v{v} من DeepNode Download Manager. انقر للتحديث.',
  ...
  hi: {
    ...
    notif_update_title: 'अपडेट उपलब्ध',
    notif_update_body: 'DeepNode Download Manager v{v} जारी हुआ है। अपडेट करने के लिए क्लिक करें।',
  ...
  id: {
    ...
    notif_update_title: 'Pembaruan tersedia',
    notif_update_body: 'DeepNode Download Manager v{v} telah dirilis. Klik untuk memperbarui.',
  ...
  vi: {
    ...
    notif_update_title: 'Có bản cập nhật',
    notif_update_body: 'DeepNode Download Manager v{v} đã phát hành. Nhấp để cập nhật.',
  ...
  ja: {
    ...
    notif_update_title: 'アップデートあり',
    notif_update_body: 'DeepNode Download Manager v{v} が公開されました。クリックして更新してください。',
  ...
  ko: {
    ...
    notif_update_title: '업데이트 가능',
    notif_update_body: 'DeepNode Download Manager v{v}이(가) 출시되었습니다. 클릭하여 업데이트하세요.',
